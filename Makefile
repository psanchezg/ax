...
.PHONY: all build build-binaries build-task-runner build-task-runner-dsh install push push-task-runner push-task-runner-dsh deploy deploy-controller deploy-server deploy-redis apply-example test coverage lint-report sonar clean
